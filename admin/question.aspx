    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group bg-danger">
                ...
                <asp:Button ID="btn_paneladdquestion" runat="server" Text="Add Question" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" OnClick="btn_paneladdquestion_Click" />
            </div>
        </div>
        <div class="card text-center mb-3">
            <div class="card-body">
                ...
                <div class="table-responsive">
                 ...
                 <asp:Panel ID="AddQuestion" runat="server" Visible="false">
