                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <asp:TextBox ID="txt_pass" runat="server" CssClass="form-control" placeholder="Enter password" Type="Password"></asp:TextBox>
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:TextBox ID="txt_repass" runat="server" CssClass="form-control" placeholder="Re-type password" Type="Password"></asp:TextBox>
